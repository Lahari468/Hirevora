 ...
 * real functionality — matching the equivalent Candidate Settings page.
 * Password change and notification preferences have no backend endpoints,
 * so they're laid out and disabled rather than faked.
 */
export function RecruiterSettingsPage(): JSX.Element {
  ...
  return (
    <AppShell title="Settings">
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader title="Notification preferences" subtitle="Choose which updates you receive." />
          <CardContent className="space-y-3">
            {["New applications", "Interview reminders", "Messages"].map((label) => (
              <label
                key={label}
