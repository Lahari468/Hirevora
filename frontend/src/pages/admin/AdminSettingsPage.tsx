 ...
 * real functionality — matching the same honest pattern used for
 * Candidate/Recruiter Settings. Password change, notification preferences,
 * and platform preferences have no backend endpoints, so they're laid out
 * and disabled rather than faked.
 */
  ...
  return (
    <AppShell title="Settings">
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader title="Notifications" subtitle="Choose which platform events you're alerted about." />
          <CardContent className="space-y-3">
            {["New reports submitted", "New user registrations"].map((label) => (
              <label
                key={label}
